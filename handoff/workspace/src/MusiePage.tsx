...
import { MusieStates } from "../musie/MusieStates";
...
type View = "workspace" | "rules" | "states";

const TITLE: Record<View, string> = {
  workspace: "The transcript workspace, in Musy",
  rules: "Layout rules — the decisions",
  states: "Draggable list — every state",
};
...
const INTRO: Record<View, string> = {
  ...
  states:
    "Every state the draggable list and its items can be in, rendered rather " +
    "than described. The spec is handoff/13-draggable-list.md; this is the " +
    "same component it documents, given props.",
};

export function Musie({ view = "workspace" }: { view?: View } = {}) {
  useMusyFonts();
